...
public class rock_paper_scissor {
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      System.out.println(
          "Qual a escolha do primeiro jogador? Digite: Pedra, Papel ou Tesoura. Para Sair do jogo pressione *");
      ...
      if (!escolha1.equals("pedra") && !escolha1.equals("papel") && !escolha1.equals("tesoura")) {
        ...
        System.out.println(
            "Qual a escolha do segundo jogador? Digite: Pedra, Papel ou Tesoura. Para Sair do jogo pressione *");
